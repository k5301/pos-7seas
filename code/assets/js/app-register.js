$().ready(function () {
    //Very Important how to call c# function from js
    $("#drpState").on("change", function () {
        __doPostBack('drpState', 'OnSelectedIndexChanged');
    });

    //Very Important how to call c# function from js : to load image again if data not saved
    //$("#btnSave").on("click", function () {
    //    if ($("#signupForm").valid())
    //        __doPostBack('lnkbtnSave', 'OnClick');
    //});


    $(document).ready(function () {
        //console.log("in");
        const wrapper = document.querySelector("#containerProfile");
        const img = document.querySelector("#profilePic");
        var path = $("#lblProfile").text();
        img.src = path;
        //alert("Hello World : " + $("#lblProfile").text());
        if (path)
            wrapper.classList.add("active");
    });


    //function img_upload(wrapper, img_src, cancel_btn, choose_file) {
    //    return 
    //    var create = function () {
    //        $("#" + choose_file).click();
    ...
    //$("#choose-profile").on("click",img_upload("profile-wrapper", "profile-img", "profile-cancel", "profile_choose"));
    ...
    //const defaultBtn = document.querySelector("#imgProfile");
    //const customBtn = document.querySelector("#custom-btn");
    //const cancelBtn = document.querySelector("#profileCancel i");
    //const img = document.querySelector("#profilePic");
    //let regExp = /[0-9a-zA-Z\^\&\'\@\{\}\[\]\,\$\=\!\-\#\(\)\.\%\+\~\_ ]+$/;
    ...
    //script of show hide password working for Password

    //const passField = document.querySelector("#usrPassword");
    //const showBtn = document.querySelector("#pass1 i");
    //showBtn.onclick = (() => {
    //    passField.focus();
    ...
    //script of show hide password working for confirm Password    

    //const passField2 = document.querySelector("#usrPasswordCnfm");
    //const showBtn2 = document.querySelector("#pass2 i");
    //showBtn2.onclick = (() => {
    //    passField2.focus();
    ...
    //                maxlength: "Your username can consist of at max 49 characters"
    //            },
    //            password: {
    //                required: "Please provide a password",
    //                minlength: "Your password must be at least 8 characters long",
    //                maxlength: "Your password can be at max 20 characters long"
    //            },
    //            confirm_password: {
    ...
    //            title: "Please enter your restaurant Title"
    //        }
    //    });
    ...
    var date = "2021-10-29";
    let m1 = moment().format("YYYY-MM-DD");
    let mx = moment(date);
    if (moment(m1).isBefore(date)) {
        console.log("valid");
    }
    else {
        console.log("invalid");
    ...
    let m2 = moment("2022-10-29");
    console.log(mx);
    //console.log(`to String() => ${m1.toString()}`);
    //console.log(`to ISOString() => ${m1.toISOString()}`);
